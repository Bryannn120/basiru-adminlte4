...
<!-- By adding /back/vendors/styles/dark/adminlte-dark-addon.css then the page supports both dark color schemes, and the page author prefers / default is light. -->
<meta name="color-scheme" content="light dark">
<!-- By adding /back/vendors/styles/dark/adminlte-dark-addon.css then the page supports both dark color schemes, and the page author prefers / default is dark. -->
...
<!-- Theme style -->
<link rel="stylesheet" href="/back/vendors/styles/adminlte.css">

<!-- For RTL verison use /back/vendors/styles/rtl/adminlte.rtl.css, remove dist/css/adminlte.css -->
<!-- <link rel="stylesheet" href="/back/vendors/styles/rtl/adminlte.rtl.css""> -->

<!-- For dark mode use /back/vendors/styles/dark/adminlte-dark-addon.css, do not remove dist/css/adminlte.css or if usinf RTL version do not remove /back/vendors/styles/rtl/adminlte.rtl.css-->
<!-- ... and then the alternate CSS first as a snap-on for dark color scheme preference -->
<!-- <link rel="stylesheet" href="/back/vendors/styles/dark/adminlte-dark-addon.css" media="(prefers-color-scheme: dark)""> -->
    ...
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
          <a href="#" class="dropdown-item">
            ...
            <div class="d-flex">
              <div class="flex-shrink-0">
                <img src="/back/vendors/images/y.png" alt="User Avatar" class="img-size-50 img-circle me-3">
              </div>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="d-flex">
              <div class="flex-shrink-0">
                <img src="/back/vendors/assets/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle me-3">
              </div>
              <div class="flex-grow-1">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="d-flex">
              <div class="flex-shrink-0">
                <img src="/back/vendors/assets/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle me-3">
              </div>
              <div class="flex-grow-1">
                <h3 class="dropdown-item-title">
                  Nora Silvester
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
          <img src="/back/vendors/images/y.png" class="user-image img-circle shadow" alt="User Image">
          <span class="d-none d-md-inline">Bryan Oktoviano R</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src="/back/vendors/images/y.png" class="img-circle shadow" alt="User Image">

            <p>
              Bryan Oktoviano Ramadhan
              <small>Admin Basiru. 2024</small>
            </p>
          </li>
          <!-- Menu Body -->
          <li class="user-body">
...
<aside class="main-sidebar sidebar-bg-dark sidebar-color-primary shadow">
  <div class="brand-container">
    <a href="javascript:;" class="brand-link">
      <img src="/back/vendors/assets/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image opacity-80 shadow">
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="/back/vendors/assets/img/user1-128x128.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                      ...
                      <div class="direct-chat-msg end">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="/back/vendors/assets/img/user3-128x128.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                    ...
                    <div class="direct-chat-contacts">
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/back/vendors/assets/img/user1-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/back/vendors/assets/img/user7-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/back/vendors/assets/img/user3-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/back/vendors/assets/img/user5-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/back/vendors/assets/img/user6-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/back/vendors/assets/img/user8-128x128.jpg" alt="User Avatar">
...
<!-- AdminLTE App -->
<script src="/back/vendors/scripts/adminlte.js"></script>
